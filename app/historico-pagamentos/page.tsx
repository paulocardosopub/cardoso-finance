...
export default function HistoricoPagamentosPage() {
  ...
  const loadHistory = useCallback(async () => {
    ...
    if (!supabase) return;
    setLoadingRows(true);
    const result = await supabase.rpc("list_employee_payment_history", { target_org: organizationId });
  ...
  return <div className="content">
    <div className="page-heading"><div><div className="eyebrow"><History size={13} /> OPERAÇÃO DA FUNCIONÁRIA</div><h1>Histórico de pagamentos</h1><p className="subtitle">Pagamentos confirmados por você, incluindo competências de meses anteriores.</p></div><div className="tag"><CalendarDays size={13} /> Todos os meses</div></div>
