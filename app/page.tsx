...
export default function DashboardPage() {
  ...
  return <div className="content">
    <div className="page-heading"><div><div className="eyebrow"><TrendingUp size={13} /> Agosto 2026</div><h1>Boa tarde, Paulo.</h1><p className="subtitle">Aqui está a visão consolidada da sua riqueza.</p></div><Link href="/onboarding" className="button button-primary"><Plus size={15} /><span>Adicionar patrimônio</span></Link></div>
    <section className="metrics">
      <Metric icon={<CircleDollarSign size={15} />} label="Patrimônio total" value={compactBrl(totalValue + 2_500_000)} foot="↑ 4,8% este mês" positive />
