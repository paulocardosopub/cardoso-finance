...
export default function DespesasPage() {
  ...
  useEffect(() => {
    ...
    if (role === "viewer") {
      ...
      supabase.rpc("list_member_expenses", { target_org: organizationId }).then(({ data, error }) => {
