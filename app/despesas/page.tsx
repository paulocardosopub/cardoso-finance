...
export default function DespesasPage() {
  ...
  useEffect(() => {
    ...
    if (role === "viewer") {
      ...
      (previewingMember ? supabase.rpc("list_member_expenses", { target_org: organizationId, target_member_user: viewAsMemberId }) : supabase.rpc("list_member_expenses", { target_org: organizationId })).then(({ data, error }) => {
