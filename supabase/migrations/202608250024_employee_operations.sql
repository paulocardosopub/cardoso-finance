...
begin
  ...
  if mark_paid then
    ...
    on conflict (source_payment_id) do update set value=excluded.value, revenue_date=excluded.revenue_date, competence=excluded.competence, description=excluded.description, notes=excluded.notes;
  else
