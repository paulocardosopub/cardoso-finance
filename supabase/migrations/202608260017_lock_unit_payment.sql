-- Serializa a confirmação por unidade para impedir que dois usuários criem
-- contratos operacionais ou pagamentos duplicados ao mesmo tempo.
...
begin
  ...
  -- O bloqueio da unidade mantém a operação atômica quando dois usuários
  -- tentam confirmar o mesmo imóvel simultaneamente.
  ...
  -- Unidades importadas podem ter aluguel cadastrado sem contrato formal.
