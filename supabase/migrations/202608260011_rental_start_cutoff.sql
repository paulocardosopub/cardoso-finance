-- Rental data was first introduced into the holding in August 2026.
-- Keep historical member views explicit: before that competence there are
-- no rental receipts or rental amounts to distribute.
...
declare
  ...
  rental_start date := date '2026-08-01';
...
begin
  ...
  if month_start >= rental_start then
